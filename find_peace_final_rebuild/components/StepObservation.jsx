  ...
  return (
    <div className="card">
      <div className="card-header">
        <h2>Observation</h2>
        <button className="help-icon" onClick={toggleHelp}>?</button>
      </div>
      <textarea
        value={observation}
      ...
      {showHelp && (
        <div className="slide-panel">
          ...
          <p>An observation is what you actually saw or heard — something a video camera could record. Avoid opinions, interpretations, or assumptions.</p>
          <ul>
