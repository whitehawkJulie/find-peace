...
// ── List data ─────────────────────────────────────────────────────────────────
// Plain arrays — not content nodes. Tone variants can be added when needed by
// converting to { default: [...], tone: { sweary: [...] } } and resolving in the component.

export const introductionFeelingList = [
...
export const introductionFourSteps = [
...
export const introductionContent = {
	...
	title: {
		default: "Feel Better",
		tone: { sweary: "WTF just happened and how do I make it stop?!" },
	},
	...
	feelingListIntro: {
		default: "If you're feeling anything like this:",
		tone: { sweary: "Feeling any of this right now?" },
	},
	...
	fourThingsIntro: {
		default: "This process helps you pause and get clear on four things:",
		tone: { sweary: "Here's what we'll work through:" },
	},
	...
	thingsShift: {
		default: "This makes a huge difference. Things shift.",
		tone: { sweary: "It actually works. Things shift." },
	},
};

// ── Help content ──────────────────────────────────────────────────────────────

export const introductionHelpContent = (
	<>
