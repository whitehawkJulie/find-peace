...
const StandaloneHelpTopics = [
	{
		...
		content: (
			<>
				...
				<p>
					This process is designed to help you navigate difficult situations by guiding you through a
					structured approach to understanding your experiences and connecting with your underlying needs. If
					you're new to this and not sure what to use it for,{" "}
					<HelpLink topic="think-of-situation">think of a situation you can try it out with.</HelpLink>
				</p>
				<p>
				...
				<img src="/images/conflict.jpg" alt="" style={{ width: "100%", display: "block", marginTop: "1rem" }} />
				<h3>... but we can get to this</h3>
				<img src="/images/field-of-needs.jpg" alt="" style={{ width: "100%", display: "block" }} />
			</>
		),
	},
	...
	{
		id: "think-of-situation",
		title: "Think of a Situation",
		content: (
			<>
				<p>
	...
	{
		id: "whether-to-converse",
		active: true,
		title: "Is a conversation worth having?",
		content: (
			<>
				<p>
					Here we're exploring whether a conversation would actually serve you, so that you can choose your
