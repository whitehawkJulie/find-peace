...
const WhetherToConverse = () => {
	return (
		<div>
			<p className="step-purpose">{"Here we're exploring whether a conversation would actually serve you, so that you can choose your next step with clarity."}</p>
			...
			<p>{"If this person isn't capable of meeting this need, don't give up on it — find ways to meet it elsewhere. Hold tightly to your needs, and loosely to your strategies."}</p>
		</div>
	);
};
