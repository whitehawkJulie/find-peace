const needsData = {
	...
	Connection: {
		Affection: [
			...
			{ item: "Connection", meaning: "Feeling linked to others and to life", status: "" },
		...
		"To matter": [
			...
			{ item: "Acknowledgement", meaning: "Having your experience or contribution recognised", status: "" },
